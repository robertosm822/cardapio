...
class DataPtBrBehavior extends ModelBehavior {
	...
	//uma função que verifica os tipos de campos do banco de dados e executa a
	//função organiza() em cada campo do tipo datetime
		...
		foreach($resultados as $key => $value):
			...
			//se não
				...
				foreach($colunas as $coluna => $tipo){
					...
					if($tipo != 'datetime') unset($colunas[$coluna]);
				}
